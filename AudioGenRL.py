...
print(f"Entropy of a song using 12 notes uniformly: {round(calculate_entropy(signal_12_bins_uniform), 2)}")
print(f"Entropy of a song using 6 notes uniformly: {round(calculate_entropy(signal_6_bins_uniform), 2)}")